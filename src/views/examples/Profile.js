                        ...
                        <Card className="card-lift--hover shadow border-0">
                          <CardBody className="py-5">
                            ...
                            <p>
                              ...
                              where users can watch & play together various
                              games available on the platform. It's 1st Ever
                              Video Vote Gaming App- Vote for New Videos
                              submitted by Creators Daily.
                            </p>
                            <p></p>
                            <div>
                        ...
                        <Card className="card-lift--hover shadow border-0">
                          <CardBody className="py-5">
                            ...
                            <p>
                              ...
                              & vegetables, and more at awesome prices and
                              discount.
                            </p>
                            <div>
                    ...
                    >
                      <Col lg="11">
                        ...
                        <p className="lead text-white mt-3">
                          ...
                          same.
                          <br />
                          Art can express the viewpoint of the artist, ask
                          social or political questions, or exists only for the
                          purpose of adding beauty to its environment. Design
                          doesn’t have this luxury. Design always has a specific
                          purpose. It must achieve a goal, and if it doesn’t,
                          it’s judged to be bad design.
                        </p>
                      </Col>
                    </Row>
                  </div>
